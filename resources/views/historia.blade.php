...
<header class="site-navbar site-navbar-target" role="banner">
    ...
    <div class="wide">
        ...
        <div class="col-xs-2 logo">HISTÓRIA</div>
        <div class="col-xs-5 line"><hr></div>
    </div>
        ...
        <div class="main-timeline">
            ...
            <div class="timeline">
                ...
                <div class="date-content">
                    <div class="date-outer">
                                    <span class="date">
                                            <span class="month">15 Fevereiro</span>
                                    <span class="year">2002</span>
                                    </span>
                    </div>
                </div>
                <div class="timeline-content">
                    <h5 class="title">Constituição</h5>
                    <p class="description">
                        Foi constituída por escritura pública, no 1º Cartório Notarial de Viana do Castelo, com os seus estatutos aprovados e publicados em Diário da República, III Série, número 108.
                    </p>
                </div>
            </div>
            ...
            <div class="timeline">
                ...
                <div class="date-content">
                    <div class="date-outer">
                                    <span class="date">
                                            <span class="month">10 de Maio</span>
                                    <span class="year">2002</span>
                                    </span>
                    </div>
                </div>
                <div class="timeline-content">
                    ...
                    <p class="description">
                        Teve a sua primeira sede (provisória) na Escola Superior de Tecnologia e Gestão/IPVC, em Viana do Castelo; tem por missão prestar assessoria técnico-científica, desenvolver projetos de formação e de diagnósticos sociodemográficos, no sentido de satisfazer necessidades de contexto local/regional.
                    </p>
                </div>
            </div>
            <!-- end experience section-->
