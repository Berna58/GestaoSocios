<title>ASSOCIAM - Conta Suspensa</title>
...
<div class="card">
    <div class="card-body">
        <h5 class="card-title">Conta Suspensa!</h5>
        <div class="icon-box mt-3 mb-3">
            <i class="fa fa-spinner" aria-hidden="true"></i>
        </div>
        <p class="card-text">A sua conta encontra-se suspensa. <br> Entre em contacto com um administrador.</p>
        <p class="card-text">Obrigado!</p>
