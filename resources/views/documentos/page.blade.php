...
<head>
    ...
    <title>ASSOCIAM - Documentos</title>
</head>
<body>
...
<header class="site-navbar site-navbar-target" role="banner">
    ...
    <div class="wide">
        ...
        <div class="col-xs-2 logo">DOCUMENTOS</div>
        <div class="col-xs-5 line"><hr></div>
    </div>

    <div class="row ml-5 mr-5 justify-content-center">
        @foreach($documentos as $documento)
            <div class="col-xl-6 col-md-12 mb-3 mt-5">
                <div class="card overflow-hidden shadow">
                    <div class="card-content">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="mr-2">
                                    <i class="fas fa-2x fa-file" style="color: #5A6268"></i>
                                </div>
                                <div class="flex-grow-1">
                                    <h4 class="mb-0 ml-3">{{ $documento->titulo }}</h4>
                                </div>
                                <div>
                                    <a class="btn btn-dark btn-icon animated-hover mr-2" href="{{ route('documentos.download', $documento->id) }}" title="Download Documento">
                                        <i class="fa fa-download" aria-hidden="true" title="Fazer Download"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.btn-visualizar', function() {
            var documentoId = $(this).data('documento');
            var iframe = $('#documentoIframe' + documentoId);
            iframe.attr('src', "{{ route('documentos.visualizar', '') }}/" + documentoId);
            $('#documentoModal' + documentoId).modal('show');
        });
    });
</script>
