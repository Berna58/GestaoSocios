...
<header class="site-navbar site-navbar-target" role="banner">
    ...
    <div class="wide">
        ...
        <div class="col-xs-2 logo">PUBLICAÇÕES</div>
        <div class="col-xs-5 line"><hr></div>
    </div>
    ...
    <div class="container mt-5 ">
        <div class="row">
            @foreach($publicacoes as $publicacao)
                <div class="col-md-2 col-sm-6 item ml-lg-5 mr-4">
                    <div class="card item-card card-block">
                        <img src="{{ asset($publicacao->imagem) }}" alt="Photo of sunset">
                        <h5 class="item-card-title mt-3 mb-3">{{ Str::limit($publicacao->titulo, 30) }}</h5>
                        <p class="card-text">{{ Str::limit($publicacao->descricao, 30) }}</p>
                        <a class="btn btn-dark btn-icon animated-hover" href="{{ route('publicacoes.ver', ['id' => $publicacao->id]) }}" title="Abrir Publicação">
                            <i class="fa fa-eye" aria-hidden="true" title="Abrir Publicação"></i> Abrir
                        </a>
                    </div>
                </div>
            @endforeach
