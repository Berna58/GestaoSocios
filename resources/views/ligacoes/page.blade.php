...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/ligacao.css')}}">
    ...
    <title>ASSOCIAM - Ligações Úteis</title>
    <style>
        .small-text {
...
<header class="site-navbar site-navbar-target" role="banner">
    ...
    <div class="wide">
        ...
        <div class="col-xs-2 logo">LIGAÇÕES ÚTEIS</div>
        <div class="col-xs-5 line"><hr></div>
    </div>
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive table-scroll" data-mdb-perfect-scrollbar="true" style="position: relative; height: 700px">
                                        <table class="table table-striped mb-0">
                                            <thead style="background-color: #616166;">
                                            <tr>
                                            ...
                                            @foreach($ligacoes as $ligacao)
                                                <tr>
                                                    <td class="small-text">{{ $ligacao->descricao }}</td>
                                                    <td class="small-text">{{ $ligacao->instituicao }}</td>
                                                    <td class="small-text">{{ $ligacao->email }}</td>
                                                    <td class="small-text"><a href="{{ $ligacao->link }}" target="_blank">{{ $ligacao->link }}</a></td>
                                                    <td class="small-text">{{ $ligacao->telefone }}</td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
